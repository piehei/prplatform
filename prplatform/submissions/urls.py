...
urlpatterns = [
        ...
        path('s/<int:pk>/', view=views.OriginalSubmissionDetailView.as_view(), name="original-detail"),
        path('r/<int:pk>/', view=views.ReviewSubmissionDetailView.as_view(), name="review-detail"),
]
