...
ROOT_DIR = environ.Path(__file__) - 3  # (prplatform/config/settings/base.py - 3 = prplatform/)
APPS_DIR = ROOT_DIR.path('prplatform')
...
LOCAL_APPS = [
    ...
    'prplatform.aplus_integration.apps.AplusIntegrationConfig',
]
...
MIGRATION_MODULES = {
    'sites': 'prplatform.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'prplatform.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'prplatform.users.adapters.SocialAccountAdapter'
